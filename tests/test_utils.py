...
def get_test_logging_xml():
    ...
    set_element_attrs(dir_element, {"name":"dir1", "basename":"dir1", "username":"root", "group":"root", "perms":"02775"})

    file_element = newdoc.createElement("file")
    set_element_attrs(file_element, {"name":"file.txt", "basename":"file.txt", "username":"root", "group":"root", "perms":"02775"})
